...
export default {
  ...
  async fetch() {
    ...
    */
    ...
    if (this.repo.isSuseAppCollectionAvailable) {
  ...
  methods: {
    ...
    async setImagePullSecretData() {
      if (this.selectedSecret && this.repo.isSuseAppCollectionAvailable && this.dontUseDefaultOption !== null) {
    ...
    async finish(btnCb) {
      try {
        ...
        if (!isUpgrade && this.isNamespaceNew && this.repo.isSuseAppCollectionAvailable) {
      ...
      */
      ...
      const chart = {
        ...
        annotations: {
          ...
          ...(this.repo.isSuseAppCollectionAvailable ? { [CATALOG_ANNOTATIONS.SUSE_APP_COLLECTION]: 'true' } : {}),
        },
        values,
      };
    ...
    >
      ...
      <template #basics>
        <div class="step__basic">
          ...
          <div
            v-if="repo.isSuseAppCollectionAvailable"
            class="mb-20"
          >
            <Banner
              color="info"
